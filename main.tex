...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[      xlabel={taille du coté},      ylabel={temps d’execution (s)},      grid=major, legend entries={temps d’execution},      legend style={at={(0.02,0.98)}},width=10cm, height=7cm  ]
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[      xlabel={taille du coté},      ylabel={nombre de resultat},      grid=major, legend entries={nombre de resultat},      legend style={at={(0.02,0.98)}},width=10cm, height=7cm    ]
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.9]
        \begin{axis}[xlabel={$k$}, ylabel={k*$k!$}, ymode=log]
        \addplot[domain=0:30, samples=50] {x*factorial(x)};
        \end{axis}
        \end{tikzpicture}
