...
(* Fonction pour trouver la prochaine position vide dans le tableau *)  
  ...
  let rec backtrack_paving_once board bouwkamp_code =
    ...
    | square_size :: remaining_sizes ->
      ...
      | Some pos ->
        ...
        match backtrack_paving_once board remaining_sizes with
        | Some solution_board -> Some solution_board
        | None -> remove_square board square_size pos;
         None;;
...
let rec backtrack_paving_ameliorer board bouwkamp_code_permutations =
  ...
  | bouwkamp_code :: remaining_permutations ->
    let solution_board_opt = backtrack_paving_once board bouwkamp_code in
...
let dlist = [50;35;27;8;19;15;17];;
let bouwkamp_code_permutations = perm bouwkamp_code;;
let bouwkamp_code_permutations = perm dlist;;
let solution_board_opt = backtrack_paving_ameliorer board bouwkamp_code_permutations